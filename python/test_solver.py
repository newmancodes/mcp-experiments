...
@pytest.mark.parametrize(
    "numbers,target_value,expected_solution_steps",
    [
        ([1, 2, 3, 4, 5, 6], 12, 3),
        ([1, 4, 4, 5, 6, 50], 350, 4),
        ([1, 3, 3, 8, 9, 50], 410, 5),
...
def test_a_puzzle_with_a_solution_is_reported_as_such_with_solution(
    numbers: list[int], target_value: int, expected_solution_steps: int
) -> None:
