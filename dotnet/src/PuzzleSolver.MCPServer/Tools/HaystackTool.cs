...
public static class HaystackTool
{
    ...
    [Description("Locates occurrences of a specified value, known as the needled, within a larger string, known as the haystack. The search does not count overlapping occurrences, so if the searched value (needle) is a palindrome, the end of one match will not be counted as the start of another potential match.")]
